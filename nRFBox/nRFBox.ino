...
const unsigned char* bitmap_icons[NUM_ITEMS] = {
  ...
  bitmap_icon_wifi, bitmap_icon_wifi_jammer, bitmap_icon_eviltwin, bitmap_icon_spammer,
...
void (*menu_functions[NUM_ITEMS])() = {
  ...
  EvilTwin::eviltwinSetup, BeaconSpammer::spammerSetup, utils, Setting::settingSetup, ScreenSaver::screensaverSetup
};
...
void (*menu_loop_functions[NUM_ITEMS])() = {
  ...
  EvilTwin::eviltwinLoop, BeaconSpammer::spammerLoop, nullptr, Setting::settingLoop, ScreenSaver::screensaverLoop
};
